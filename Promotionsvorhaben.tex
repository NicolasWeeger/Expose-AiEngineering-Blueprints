...
In der zweiten Phase wurde die Notwendigkeit und die Ziele der Forschung in Richtung AI-Engineering Blueprints für KMU untersucht. Die Ergebnisse dieser Phase wurden in einem Paper zusammengefasst, welches als peer reviewed Konferenzbeitrag im Rahmen des Software Architecture for Machine Learning (SAML) Workshop der International Conference on Software Architecture (ICSA) 2025 in Odense, Dänemark im April 2025 veröffentlicht \cite{weegerTowards2025}.
